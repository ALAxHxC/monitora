...
function initDatabase(app) {
	...
	const classifications = require('../../model/classification/Classification')(app, mongoose)
	const typification = require('../../model/classification/Typification')(app, mongoose)
